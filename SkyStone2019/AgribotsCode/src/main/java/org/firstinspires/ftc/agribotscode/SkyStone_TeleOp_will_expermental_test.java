 ...
 */
@TeleOp(name = "SkyStone_TeleOp_will_test", group = "SkyStone")
public class SkyStone_TeleOp_will_expermental_test extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            drive.setSpeedFactor(speedFactor);
